...
def download(url, file_name): #download file from url to file
    urllib.request.urlretrieve('http://flibusta.is' + url + '/fb2', 'c:\\temp\\file.fb2') #TODO fix place to save
...
def main():
    ...
    for book in book_list: print(book_list[book] )
